...
<?= $this->Html->script('bib/bootstrap.min.js'); ?>  <!-- Can be remove if using angular ? -->

<?= $this->Html->script('util'); ?>
<?= $this->Html->script('cakephp.util'); ?>         


<?= $this->Html->script("lodash.min.js"); ?> <!-- Used by the slider ? -->
...
<?= $this->Html->script("angularjs/angular-simple-logger.min.js"); ?> <!-- Use online lib ? -->
...
<?= $this->Html->script("angular-socialshare/angular-socialshare.min.js"); ?>   <!-- Can be lighter -->
<?= $this->Html->script("satellizer/satellizer.min.js"); ?>                     <!-- Can be lighter -->
